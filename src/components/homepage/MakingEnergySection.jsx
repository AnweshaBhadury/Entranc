    ...
    <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="absolute bottom-4 left-0 w-full overflow-hidden">
            ...
            >
                ...
                {card.hasMarquee && (
                    <>
                        <p className="inline-block font-bold text-lg bg-s2 text-primary px-2 py-1 rounded ml-4">
                            {card.texts[1]}
                        </p>
                        <p className="inline-block font-bold text-lg bg-s2 text-primary px-2 py-1 rounded ml-4">
                            {card.texts[0]}
                ...
                <ScrollReveal>
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <p className="text-dark-gray max-w-3xl mx-auto">
                            We believe the future of energy is local, inclusive, and
