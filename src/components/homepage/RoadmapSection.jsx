...
const RoadmapCard = ({ card }) => (
    <div className={`w-full h-full p-8 rounded-3xl shadow-2xl flex flex-col justify-between text-left ${card.containerClass}`}>
        <div>
            <p className={`text-8xl font-extrabold ${card.numberClass}`}>{card.number}</p>
            <h3 className={`text-4xl font-bold mt-4 ${card.titleClass}`}>{card.title}</h3>
            ...
            <div className="container mx-auto text-center space-y-12">
                <ScrollReveal>
                    <div className="space-y-6 max-w-4xl mx-auto">
                        <h2 className="text-h2-phone md:text-h2-tab lg:text-h2-desktop font-bold leading-tight text-primary">Work Package Roadmap</h2>
                        <p className="text-dark-gray">Our work is structured into focused work packages — each led by expert partners across Europe. From citizen engagement to digital tools, these packages outline the path to delivering community-led energy transformation.</p>
                ...
                <div className="hidden md:flex h-[500px] justify-center items-center relative" style={{ perspective: '1000px' }}>
